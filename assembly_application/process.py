...
class process_operate:
    ...
    def process_start(amount):
        ...
        # 초기 공정 시작 값
        op10_timestamp = op10_data_P4_from_DB[0]['product_test_timestamp']
        op20_timestamp = op20_data_P3_from_DB[0]['product_test_timestamp']
        op30_timestamp = op30_data_P2_from_DB[0]['product_test_timestamp']
        op40_timestamp = op40_data_P1_from_DB[0]['product_test_timestamp']
        op50_timestamp = op50_data_P0_from_DB[0]['product_test_timestamp']
        op60_timestamp = op50_data_P0_from_DB[0]['product_test_timestamp']
